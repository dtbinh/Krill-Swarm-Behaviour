...
leaders = 0.35;   % percentage of "leaders"
...
resFile = 'sim_35_01.mat'; %file to save results

save('vars_sim_35_01.mat','T','N','dim','n','maxs','maxf','r','w','leaders','targetV','lactiv','leadRatio','errMargin','closeL');
main;