...
leaders = 0.5;   % percentage of "leaders"
...
resFile = 'res_sim5_11.mat'; %file to save results

save('vars_sim5_11.mat','T','N','dim','n','maxs','maxf','r','w','leaders','targetV','lactiv','leadRatio','errMargin','closeL');
main;