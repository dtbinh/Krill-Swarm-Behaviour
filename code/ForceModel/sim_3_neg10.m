...
leaders = 0.3;   % percentage of "leaders"
targetV = [-1,0]; % targeted vector of leaders
...
resFile = 'vars_sim3_neg10.mat'; %file to save results

save('vars_sim3_neg10.mat','T','N','dim','n','maxs','maxf','r','w','leaders','targetV','lactiv','leadRatio','errMargin','closeL');
main;