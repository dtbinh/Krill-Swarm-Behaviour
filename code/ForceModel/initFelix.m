...
T = 2;  %number of simulations (if 1 there will be no graph output)
...
leaders = 0.2;   % percentage of "leaders"
targetV = [1,1]; % targeted vector of leaders
...
errMargin = 0.3; %error margin when comparing vector of non-leader to targetV
closeL = 0.25; %distance for measuring if krill is near non-leader


resFile = 'sim2.mat'; %file to save results

uisave({'T','N','dim','n','maxs','maxf','r','w','leaders','targetV','lactiv','leadratio','errMargin','closeL','random'},'vars_sim2.mat');
main;