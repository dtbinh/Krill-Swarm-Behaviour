...
leaders = 0.45;   % percentage of "leaders"
...
resFile = 'sim_45_01.mat'; %file to save results

save('vars_sim_45_01.mat','T','N','dim','n','maxs','maxf','r','w','leaders','targetV','lactiv','leadRatio','errMargin','closeL');
main;